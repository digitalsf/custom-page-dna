window.addEventListener('load', function () {
    ...
    //wrap order buttons on home page
    if( $('.index-container').length ) {
        $('#newscopy-wrapper').nextUntil('div:not(.center)').andSelf().wrapAll('<div class="start-order-box col-12 col-lg-8 col-xl-6 mb-lg-4" />');
        $('.start-order-box').next('div').andSelf().wrapAll('<div class="row g-0" />');
        $('.start-order-box').next('div').addClass('logo-box col-12 col-lg-4 col-xl-6 mb-4');
    }
